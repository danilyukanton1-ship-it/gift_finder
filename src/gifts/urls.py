...
urlpatterns = [
    ...
    path('ajax/get-tags-by-question/', views.get_tags_by_question, name='get_tags_by_question'),
    path('products/<int:product_id>/select', views.selected_products, name='selected_products'),
