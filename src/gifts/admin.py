    ...
    def __init__(self, *args, **kwargs):
        ...
        if self.instance.pk:
            self.selected_tag_ids = list(
                self.instance.tags.values_list("id", flat=True)
            )
...
class ProductAdmin(admin.ModelAdmin):
    ...
    def get_fieldsets(self, request, obj=None):
        fieldsets = [
            ("Main information", {"fields": ["name", "direction", "in_stock"]}),
            ("Price", {"fields": ["price", "currency"]}),
            ("Source", {"fields": ["source", "product_url", "image_url"]}),
            ("Rating and description", {"fields": ["rating", "description"]}),
            ("Tag filter", {"fields": ["tag_question"], "classes": ["wide"]}),
            (
                "System information",
                {"fields": ["created_at", "last_checked"], "classes": ["collapse"]},
            ),
        ]
        return fieldsets
